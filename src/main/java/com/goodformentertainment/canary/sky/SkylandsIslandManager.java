...
public class SkylandsIslandManager {
    ...
    public SkylandsIslandManager(final SkylandsConfig config) {
        this.config = config;
    ...
    public void generateIsland(final World world, final int x, int y, final int z) {
        SkylandsPlugin.LOG.debug("Generating island at " + x + ":" + y + ":" + z);
    ...
    public void clearIsland(final World world, final Player player, final int islandId) {
        SkylandsPlugin.LOG.debug("Deleting island " + islandId);
        ...
        TaskManager.submitTask(new Runnable() {
            ...
            public void run() {
                ...
                // Deletion completion
                SkylandsPlugin.LOG.debug("Island " + islandId + " deleted");
